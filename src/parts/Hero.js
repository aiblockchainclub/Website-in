  ...
  return (
    <section className="hero">
      <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        ...
        <p className="font-light text-xl text-gray-400 leading-relaxed mb-16 max-len-150">
          We’re transforming the digital frontier with cutting-edge game development and pioneering solutions in Web3 and blockchain technology. At ROMPIT, we combine creativity, technology, and strategy to build immersive gaming experiences and empower decentralized ecosystems.
        </p>
