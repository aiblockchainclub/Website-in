...
export const Aboutus = [
  {
    title: 'Who we are',
    animation: 'left',
    description:'At ROMPIT, we’re a passionate team of developers, designers, and innovators dedicated to reshaping the gaming and blockchain landscape. Established with a vision to fuse creativity with technology, we specialize in delivering next-generation games and scalable blockchain solutions that resonate with the future of digital interactions.'
  },
  {
    title: 'Our Mission',
    animation: 'right',
    description : 'To inspire, innovate, and empower through exceptional game development and seamless integration of Web3 and blockchain technologies.',
  },
  {
    title: 'Our Vision',
    animation: 'left',
    description: 'Revolutionizing Decentralized Web! Empowering Users and Developers in the Web3 Ecosystem'
  }
]
